...
namespace xadrez
{
    class PartidaDeXadrez
    {
        ...
        public Peca executaMovimento(Posicao origem, Posicao destino)
        {
            ...
            {
                Posicao originaT = new Posicao(origem.linha, origem.coluna + 3);
                Posicao destinoT = new Posicao(origem.linha, origem.coluna + 1);
                Peca T =  tab.retirarPeca(originaT);
                T.incrementarQdeMovimento();
                tab.colocarPeca(T, destinoT);
            }
            // #jogadaespecial roque grande
            if (p is Rei && destino.coluna == origem.coluna - 2)
            {
                Posicao originaT = new Posicao(origem.linha, origem.coluna - 4);
                Posicao destinoT = new Posicao(origem.linha, origem.coluna - 1);
                Peca T = tab.retirarPeca(originaT);
                T.incrementarQdeMovimento();
                tab.colocarPeca(T, destinoT);
        ...
        public void desfazMovimento(Posicao origem, Posicao destino, Peca pecaCapturada)
        {
            ...
            if (p is Rei && destino.coluna == origem.coluna + 2)
            {
                ...
                T.decrementarQdeMovimento();
                tab.colocarPeca(T, originaT);
            }
        ...
        public void validarPosicaoDeOrigem(Posicao pos)
        {
            ...
            {
                throw new TabuleiroException("Ñão há movimentos possíveis para a peça de origem escolhida!");
            }
        }
